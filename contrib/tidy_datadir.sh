...
if [ -f wallet.dat -a -f peers.dat -a -f coins/CURRENT -a -f blktree/CURRENT -a -f bricks/blk00000.dat ]; then LEVEL=3; fi
if [ -f wallet.dat -a -f peers.dat -a -f wallstate/CURRENT -a -f bricks/index/CURRENT -a -f bricks/blk00000.dat ]; then LEVEL=4; fi
