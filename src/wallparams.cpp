...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.magacoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("magacointools.com", "dnsseed.magacointools.com"));
        vSeeds.push_back(CDNSSeedData("magacoinpool.org", "dnsseed.magacoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("magacointools.com", "testnet-seed.magacointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.magacoin.loshan.co.uk", true));
