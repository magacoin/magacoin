...
static const uint64_t BRICK_WALL_SIZE = 7;
/* Minimum free space (in GB) needed for data directory when pruned; Does not include prune target */
static const uint64_t WALL_STATE_SIZE = 2;
    ...
    signalled(false)
{
    ...
    requiredSpace = BRICK_WALL_SIZE;
    if (pruneTarget)
        requiredSpace = WALL_STATE_SIZE + std::ceil(pruneTarget * 1024 * 1024.0 / GB_BYTES);
